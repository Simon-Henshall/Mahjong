...
namespace Tests
{
    ...
    public class BaseGameplayMechanics : Base
    {
        [Test]
    ...
    [TestFixture]
    public class ChiCalcuation : Base
    {
        ...
        public void TestHasChi(Hand testHand)
        {
            ...
            var result = _mainLogic.CalculateChi(player);
    ...
    [TestFixture]
    public class PongCalcuation : Base
    {
        ...
        public void TestHasPong(Hand testHand)
        {
            ...
            var result = _mainLogic.CalculatePong(player);
            Assert.IsTrue(result);
    ...
    [TestFixture]
    public class KangCalcuation : Base
    {
        ...
        public void TestHasKang(Hand testHand)
        {
            ...
            var result = _mainLogic.CalculateKang(player);
            Assert.IsTrue(result);
